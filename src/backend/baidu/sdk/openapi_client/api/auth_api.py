...
from ..model.oauth_token_authorization_code_response import (
...
class AuthApi(object):
    ...
    def oauth_token_code2token(
        self, code, client_id, client_secret, redirect_uri, **kwargs
    ):
    ...
    def oauth_token_device_code(self, client_id, scope, **kwargs):
    ...
    def oauth_token_device_token(self, code, client_id, client_secret, **kwargs):
    ...
    def oauth_token_refresh_token(
        self, refresh_token, client_id, client_secret, **kwargs
    ):
