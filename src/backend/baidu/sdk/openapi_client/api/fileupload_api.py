...
class FileuploadApi(object):
    ...
    def pcssuperfile2(self, access_token, partseq, path, uploadid, type, **kwargs):
    ...
    def xpanfilecreate(
        self, access_token, path, isdir, size, uploadid, block_list, **kwargs
    ):
    ...
    def xpanfileprecreate(
        self, access_token, path, isdir, size, autoinit, block_list, **kwargs
    ):
